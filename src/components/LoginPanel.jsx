...
export default function LoginPanel() {
  ...
  const handleLogin = () => {
    let hasError = false;
    if (!vin.trim()) { setVinError(true);  hasError = true; } else setVinError(false);
    if (!pin.trim()) { setPinError(true);  hasError = true; } else setPinError(false);
      ...
      <div className="login-panel__body">
        ...
        <div className="login-panel__field">
          ...
          <input
            ...
            type="text"
            value={vin}
            onChange={(e) => { setVin(e.target.value); setVinError(false); }}
        ...
        <a href="#" className="login-panel__link">Forgot Password</a>
        <a href="#" className="login-panel__link">En Español</a>
      </div>
    </div>
  );
}
